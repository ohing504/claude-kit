...
- **안 한다 — 판단**: 처분 판단(자산화/폐기/보류), 어디로 흡수할지(라우팅), 무엇을 삭제할지 *결정*, 과거 결정 학습. 이건 전부 스킬 밖이다. 스킬은 **사실만 기록하고 판단하지 않는다.** 그 문서를 받은 사용자(또는 사용자의 노트 시스템 — 예: 개인 Obsidian/Second Brain 프로젝트)가 자기 기준으로 흡수·폐기를 정한다.
...
```markdown
## 1. <메모 제목 또는 영상 한 줄>
- **생성**: 2026-03-14 · **폴더**: 레시피 · **ID**: <안정 식별자, 있으면>
